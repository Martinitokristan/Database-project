...
function AdminGrades() {
  ...
  return (
    <div>
      <PageHeader title="Grades" description="View grades by section, ranked by average." />
...
function StudentGrades() {
  ...
  return (
    <div>
      <PageHeader title="My Grades" description="Academic performance for all enrolled subjects." />
      {grades.length === 0 ? (
